          ...
          <ErrorBoundary>
            <article className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="prose prose-sm sm:prose lg:prose-lg max-w-none prose-headings:text-primary-900 prose-a:text-accent-500" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              </div>
            </article>
          </ErrorBoundary>
        </main>
