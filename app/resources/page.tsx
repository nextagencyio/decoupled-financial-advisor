...
export const metadata: Metadata = {
  title: 'Resources | Meridian Wealth Partners',
  description: 'Financial planning resources and insights from Meridian Wealth Partners.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-300">
              Expert perspectives on wealth management and financial planning.
            </p>
          </div>
        </div>
      </section>
